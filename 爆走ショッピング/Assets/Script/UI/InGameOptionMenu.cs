...
public class InGameOptionMenu : MonoBehaviour
{
    ...
    private void HandleMovementControlPresetChanged(int index, string _)
    {
        ...
        foreach (PlayerManager player in FindObjectsByType<PlayerManager>())
        {
            player.ApplyControlScheme(controlScheme);
        }
    }
    ...
    private void ResolveReferences()
    {
        ...
        if (restartManager == null)
        {
            restartManager = FindAnyObjectByType<GameRestartManager>();
        }
    }
